...
export type method = (ctx: Context, prev: any[], i?: number) => unknown | void;
...
export type Service = (this: Pd, atom: typeof Atom, instance: Atom, service: ServiceMethods) => ServiceRes;

export type OPT = $ServerOptions;

export type Socket = $Socket;
export type IO = typeof ServerIO;
